...
class StockSnapshotResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        data: collections.abc.Iterable[global___StockSnapshotMessage] | None = ...,
    ) -> None: ...
...
class StockHistoryTickResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        data: collections.abc.Iterable[global___StockHistoryTickMessage] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["data", b"data"]) -> None: ...
...
class StockHistoryKbarResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        data: collections.abc.Iterable[global___StockHistoryKbarMessage] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["data", b"data"]) -> None: ...
...
class StockHistoryCloseResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        data: collections.abc.Iterable[global___StockHistoryCloseMessage] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["data", b"data"]) -> None: ...
