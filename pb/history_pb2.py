...
HistoryKbarResponse = _reflection.GeneratedProtocolMessageType(
    "HistoryKbarResponse",
    (_message.Message,),
    {
...
HistoryKbarMessage = _reflection.GeneratedProtocolMessageType(
    "HistoryKbarMessage",
    (_message.Message,),
    {
...
HistoryCloseResponse = _reflection.GeneratedProtocolMessageType(
...
HistoryCloseMessage = _reflection.GeneratedProtocolMessageType(
    "HistoryCloseMessage",
    (_message.Message,),
    {
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _HISTORYTICKRESPONSE._serialized_start = 56
    ...
    _HISTORYKBARRESPONSE._serialized_end = 383
    _HISTORYKBARMESSAGE._serialized_start = 385
    _HISTORYKBARMESSAGE._serialized_end = 503
    _HISTORYCLOSERESPONSE._serialized_start = 505
    _HISTORYCLOSERESPONSE._serialized_end = 581
    _HISTORYCLOSEMESSAGE._serialized_start = 583
    _HISTORYCLOSEMESSAGE._serialized_end = 647
    _HISTORYDATAINTERFACE._serialized_start = 650
    _HISTORYDATAINTERFACE._serialized_end = 1715
