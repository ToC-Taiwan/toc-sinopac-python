...
VolumeRankRequest = _reflection.GeneratedProtocolMessageType(
    "VolumeRankRequest",
    (_message.Message,),
    {
...
SnapshotMessage = _reflection.GeneratedProtocolMessageType(
    "SnapshotMessage",
    (_message.Message,),
    {
...
StockVolumeRankResponse = _reflection.GeneratedProtocolMessageType(
...
StockVolumeRankMessage = _reflection.GeneratedProtocolMessageType(
